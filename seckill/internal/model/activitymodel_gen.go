...
func (m *defaultActivityModel) Insert(ctx context.Context, data *Activity) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.ActivityName, data.GoodsId, data.StartTime, data.EndTime, data.Total, data.Status, data.BuyLimit, data.BuyProbability)
	return ret, err
}
...
func (m *defaultActivityModel) Update(ctx context.Context, data *Activity) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.ActivityName, data.GoodsId, data.StartTime, data.EndTime, data.Total, data.Status, data.BuyLimit, data.BuyProbability, data.Id)
	return err
}
