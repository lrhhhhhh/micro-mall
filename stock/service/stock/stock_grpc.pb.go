...
type StockClient interface {
	...
	RedisQueryPrepare(ctx context.Context, in *DeductStockReq, opts ...grpc.CallOption) (*DeductStockResp, error)
...
func (c *stockClient) RedisQueryPrepare(ctx context.Context, in *DeductStockReq, opts ...grpc.CallOption) (*DeductStockResp, error) {
	out := new(DeductStockResp)
	err := c.cc.Invoke(ctx, "/stock.stock/redisQueryPrepare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StockServer interface {
	...
	RedisQueryPrepare(context.Context, *DeductStockReq) (*DeductStockResp, error)
...
func (UnimplementedStockServer) RedisQueryPrepare(context.Context, *DeductStockReq) (*DeductStockResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RedisQueryPrepare not implemented")
}
...
func _Stock_RedisQueryPrepare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeductStockReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).RedisQueryPrepare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stock.stock/redisQueryPrepare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).RedisQueryPrepare(ctx, req.(*DeductStockReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Stock_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "redisQueryPrepare",
			Handler:    _Stock_RedisQueryPrepare_Handler,
		},
		{
